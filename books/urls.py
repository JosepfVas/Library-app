...
from books.views import BookListAPIView, BookUpdateAPIView, BookRetrieveAPIView, BookDeleteAPIView, BookCreateAPIView, \
    TakeBookView, ReturnBookView, BookStatusListAPIView
...
urlpatterns = [
    ...
    path('delete/', BookDeleteAPIView.as_view(), name='book_delete'),

    # BookStatus CRUD.
    path('status-list/', BookStatusListAPIView.as_view(), name='book_status_list'),
    path('status-retrieve/<int:pk>/', BookStatusListAPIView.as_view(), name='book_status_retrieve'),
