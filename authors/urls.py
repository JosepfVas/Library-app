...
from authors.views import AuthorListAPIView, AuthorCreateAPIView, AuthorUpdateAPIView, AuthorRetrieveAPIView, \
    AuthorDeleteAPIView
...
urlpatterns = [
    ...
    path('delete/', AuthorDeleteAPIView.as_view(), name='author_delete'),
